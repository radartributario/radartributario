  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50 px-4">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleRegister} className="bg-white rounded-2xl shadow-lg p-8 space-y-5">
          <h2 className="text-xl font-semibold text-slate-800">Criar Conta</h2>
          {error && (
          ...
          <p className="text-center text-sm text-slate-500">
            Já tem conta?{" "}
            <Link href="/auth/login" className="text-blue-600 hover:underline font-medium">Entrar</Link>
          </p>
        </form>
      </div>
    </div>
